  ...
  with dmFiscalizacao.qryHistoricoInfrator do
    begin
      ...
      SQL.Text := 'select d.iddenuncia, ci.codinfrator, ci.infrator, ci.cpf, ci.cnpj ' +
        ...
        'and   ci.codInfrator = :cod_cidadao ';
      Parameters.ParamByName('cod_cidadao').Value := dmFiscalizacao.qryDenunciaidinfrator.AsString;
      Open;
      codInf := dmFiscalizacao.qryHistoricoInfratorcodinfrator.AsInteger;
    end;
  with dmFiscalizacao.qryHistoricoInfrator2 do
    begin
      ...
      SQL.Text := 'select n.codnotificacao ' +
        ...
        ',      fis_denuncia d ' +
        'where  n.iddenuncia = ' + QuotedStr(dmFiscalizacao.qryHistoricoInfratoriddenuncia.AsString) +
