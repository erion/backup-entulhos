object dmFiscalizacao: TdmFiscalizacao
  ...
  object qryHistoricoInfrator: TADOQuery
    ...
    SQL.Strings = (
      ...
      ',d.descricao, d.procedimentos, s.descricao as situacao '
        ...
        ',n.dataHoraNotificacao, o.descricao as ocorrencia, a.codAutoinfr' +
        'acao '
      ',a.dataHoraInfracao, a.descricao as descricaoInfracao '
      
        ',a.exigencia as exigenciaInfracao, r.codApreensao, r.dataHoraapr' +
        'eensao '
      'from fis_denuncia d left join fis_notificacao n on '
      '     n.iddenuncia = d.iddenuncia left join fis_ocorrencia o on '
      
        '     o.idOcorrencia = n.idocorrencia left join fis_autoinfracao ' +
        'a on '
      
        '     a.codNotificacao = n.codNotificacao left join fis_registroa' +
        'preensao r on '
  ...
  object dsHistoricoInfrator: TwwDataSource
    ...
    OnDataChange = dsHistoricoInfratorDataChange
    Left = 135
    Top = 234
  end
  ...
  object qryParametros: TADOQuery
    ...
    Left = 440
    Top = 160
    object qryParametrosiddenuncia: TIntegerField
      FieldName = 'iddenuncia'
    end
    object qryParametroscodinfrator: TStringField
