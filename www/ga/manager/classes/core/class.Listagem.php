...
class Listagem extends View {
	...
	function montaListagem(){
		...
		if ($this->excluir) {
			$tpl->newBlock('LABELS');
			$tpl->assign('label',"<input width=\"15\" type=\"image\" src=\"".IMG_CLASSPATH."cms-bt-excluir.gif\" title=\"Excluir registros\" alt=\"Excluir registros\" onClick=\"return confirm('Tem certeza que deseja excluir os dados?');\" />");
		}
