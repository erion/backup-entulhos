                        ...
                        <td width="300px" class="borda">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="linha" width="80px"><small><?php echo $pedido->ordem_servico ?></small></td>
                                </tr>
                            </table>
                        </td>
                        <td class="borda">
...
?>
                        <table>
                            <tr>
                                <td class="borda center" width="25px" height="25px"><?php echo $producao ?></td>
                                <td>&nbsp;Produção</td>
                            </tr>
                            <tr>
                                <td class="borda center" width="25px" height="25px"><?php echo $amostra ?></td>
                                <td>&nbsp;Amostra</td>
                            </tr>
                            <tr>
                                <td class="borda center" width="25px" height="25px"><?php echo "&nbsp;"; ?></td>
                                <td>&nbsp;DM</td>
                            </tr>
                        </table>
                    </td>
            ...
            <table>
                <tr>
                    ...
                    <td class="borda center <?php echo ($pedido->mercado == 'ME') ? 'Xbg' : '' ?>" width="20px" height="20px">ME</td>
                    <td>&nbsp;</td>
                    <td class="borda center <?php echo ($pedido->mercado == 'MI') ? 'Xbg' : '' ?>" width="20px" height="20px">MI</td>
                    <td>&nbsp;</td>
            ...
            <table>
                <tr>
                    ...
                    <td class="linha" width="80px"><?php echo "Total ".$total_artigos ?>&nbsp;</td>
                    <?php
            ...
            ?>
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="linha"><?php echo 'Conforme observação' ?></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <div class="borda">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="100px" class="linha">&nbsp;<?php echo double_br($preco_venda) ?></td>
                                        <td class="right" width="80px">Faturamento:</td>
                                        <td width="100px" class="linha">&nbsp;<?php echo $pedido->icms ?></td>
...
<?php ($usuario != USUARIO_CURTUME_PROGRAMACAO) ? $nmrTabela = '3' : $nmrTabela = '2'; ?>
                        <div class="borda">
                            <table cellspacing="0px" cellpadding="0px" >
                                ...
                                <tr>
                                    ...
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Verde/Salgado/Salmorado</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Semi-acabado</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Gaúcho</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Wet White</td>
                                    <td class="borda" width="20px" height="20px">&nbsp;</td><td>Acabado</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Brasil Central</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                            ...
                            <table cellspacing="0px" cellpadding="0px" >
                                ...
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Cartela</td>
                                    <td colspan="3">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Grampo</td>
                                    <td class="linha" width="80px" colspan="2">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Firme</td>
                                </tr>
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Carnal</td>
                                    <td colspan="3">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td class="linha" width="25%" colspan="2">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Afio</td>
                                    <td colspan="5">&nbsp;</td>
                                ...
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Flor</td>
                                    <td colspan="5">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Macio</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Integral</td>
                                </tr>
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Última produção</td>
                                    <td colspan="5">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Médio</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Lixado</td>
                                </tr>
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Padrão</td>
                                    <td colspan="5" class="linha">&nbsp;</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Armado</td>
                                    <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Estucado</td>
                                </tr>
                            </table>
                            ...
                            <div class="borda">
                                <table cellspacing="0px" cellpadding="0px" >
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Sim</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Macio</td>
                                        <td>&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Fosco</td>
                                        <td colspan="2">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Sedoso</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Áspero</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Anilina</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="borda" width="20px" height="20px">&nbsp;</td><td>Não</td>
                                        ...
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Médio</td>
                                        <td colspan="2">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Ceroso</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Travado</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Semi-anilina</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Armado</td>
                                        <td>&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Alto brilho</td>
                                        <td colspan="2">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Graxoso</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Liso</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Pigmentado</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">&nbsp;</td>
                                        <td class="borda" width="20px" height="20px">&nbsp;</td><td>Softímetro</td>
                                        <td class="linha" width="80px">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Cfe cartela</td>
                                        <td colspan="2">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Siliconado</td>
                                        <td class="borda" width="20px" height="20px">&nbsp;</td><td class="linha">&nbsp;</td>
                                        <td class="quadro" width="20px" height="20px">&nbsp;</td><td>Efeito</td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">&nbsp;</td>
                            ...
                            <table cellspacing="0px" cellpadding="0px" class="borda observacao">
                                <tr>
                            ...
                            <table cellspacing="0px" cellpadding="0px" class="borda">
                                <tr>
                ...
                <?php
                        ...
                        $contador = 0;
                        $observacao = '';
                        foreach ($artigos as $artigo_pedido){
                            $observacao .= " < ".$artigo_pedido->cor." - ".$artigo_pedido->quantidade." ".$pedido->unidade_medida." > ";
                            $contador++;
                            if($contador > 5) {
                                $contador = 0;
                                echo "<tr><td class='linha' width='100%'>".$observacao."</td></tr>";
                                $observacao = '';
                            } else $pouca_cor = true;
                        }
                        if($pouca_cor == true) echo "<tr><td class='linha' width='100%'>".$observacao."</td></tr>";
                        //OBSERVACOES PEDIDO
