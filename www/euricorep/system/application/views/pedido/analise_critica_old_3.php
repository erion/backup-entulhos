	...
	<body>
		...
		<div class="borda">
			...
			<table>
				...
				<tr>
					...
					<td class="borda" width="20px" height="20px">&nbsp;</td><td class="bold">&nbsp;AERONÁUTICO</td>
			...
			<table>
				<tr>
					...
					<td width="50px">Cupim:</td>
					<td class="borda" width="20px" height="20px">&nbsp;</td><td width="25px">Não</td>
					<td class="borda" width="20px" height="20px">&nbsp;</td><td width="25px">Sim</td>
					<td class="linha right" width="30px">&nbsp;</td>
					<td>%</td>
					<td width="140px">Tamanho médio do couro:</td>
			...
			<table>
				<tr>
					...
					<td width="20%" class="linha">&nbsp;</td>
					<td class="right" width="120px">Tipo de embalagem:</td>
					<td width="20%" class="linha">&nbsp;</td>
					<td width="110px">Tolerância metragem:</td>
					<td class="linha" width="10%">&nbsp;<?php echo $cliente->tolerancia_metragem ?></td>
				</tr>
			</table>
		...
		<div class="borda">
			...
			<table class="borda">
				...
				<tr>
					<?php //CORES INICIO ?>
					<table cellpadding="0px" cellspacing="0px" class="linha">
						<tr>
