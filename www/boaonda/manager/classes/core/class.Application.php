...
class Application{
	...
	function configurarHTML() {
		...
		if ($flash->hasFlash('retorno-titulo')) { 
			...
			$imagem = $flash->getFlash('retorno-imagem');
			(!empty($imagem))? $this->tpl->assign('retorno-imagem', $imagem) : $this->tpl->assign('retorno-imagem', 'comum/img/glitter/icone-sucesso.png');
		}
