...
class fComboAdd extends Field {
	...
	function fComboAdd($campo, $label, $campo_label, $tabela, $classe, $texto_selecione = "Selecione", $texto_novo = "Adicionar...", $editar=true, $excluir=true, $adicionar=true, $obrigatorio = true, $changeFunction = '') {
		$this->tipo = 'fComboAdd';
		$this->campo = $campo;
		$this->classe = $classe;
		$this->valor = "";
	...
	function formatForm() {
		...
		$s .= '<select class="input_select" name="'.$this->campo.'" id="'.$this->campo.'" onchange="javascript:chkComboAdd(\''.$this->campo.'\', this);'.$this->changeFunction.'">';
